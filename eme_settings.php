...
<table class="form-table">
   ...
   eme_options_radio_binary ( __ ( 'Re-enable legacy placeholder behaviour', 'eme' ), 'eme_legacy', __ ( 'Check this option if you want to re-enable the use ofthe older placeholder notation.', 'eme' ) .__('For more information, see ', 'eme')."<a target='_blank' href='http://www.e-dynamics.be/wordpress/?p=51559'>".__('the documentation', 'eme').'</a>' );
   ?>
</table>
