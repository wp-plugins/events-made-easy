...
function eme_options_register() {
   ...
   switch ( $tab ){
	      ...
	      case 'payments' :
	         ...
	         break;
	      case 'other' :
                 $options = array ('eme_thumbnail_size','eme_image_max_width','eme_image_max_height','eme_image_max_size','eme_event_html_headers_format','eme_location_html_headers_format');
	         break;
   }
...
<table class='form-table'>
   <?php
   eme_options_select ( __('Thumbnail size','eme'), 'eme_thumbnail_size', eme_thumbnail_sizes(), __('Choose thumbnail size to be shown when using the placeholder #EVENTIMAGETHUMB','eme') );
