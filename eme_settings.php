...
function eme_add_options($reset=0) {
   ...
   'eme_show_recurrent_events_once' => 0,
...
<table class="form-table">
   ...
   eme_options_radio_binary ( __ ( 'Show recurrent events only once?', 'eme' ), 'eme_show_recurrent_events_once', __ ( 'Check this option if you want to show recurrent events only once in lists. Remember that people will only see a normal event unless you add recurrent info to it using the placeholder #_RECURRENCEDESC .','eme') );
   ?>
</table>
