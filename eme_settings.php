...
function eme_options_register() {
   ...
   switch ( $tab ){
	      ...
	      case 'payments' :
	         ...
	         break;
	      case 'other' :
                 $options = array ('eme_thumbnail_size','eme_image_max_width','eme_image_max_height','eme_image_max_size','eme_event_html_headers_format','eme_location_html_headers_format','eme_fb_app_id','eme_global_zoom_factor','eme_indiv_zoom_factor');
	         break;
   }
...
<h3><?php _e ( 'Map zoom facors', 'eme' ); ?></h3>
<table class='form-table'>
   <?php
