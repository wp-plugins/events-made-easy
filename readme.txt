...
* Feature: support polylang, but only if the setting 'The language is set from content' is choosen and 'Hide URL language information for default language' is NOT checked
